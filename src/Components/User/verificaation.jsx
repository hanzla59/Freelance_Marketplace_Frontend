...
//         maxWidth="xs"
//         fullWidth
//         scroll="paper" // Center the dialog vertically
//         PaperProps={{ style: { margin: 'auto', width: '100%' } }} // Ensures horizontal centering
//       >
//         <DialogTitle sx={{ textAlign: 'center', fontSize: '2rem', color: 'green' }}>
